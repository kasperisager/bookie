...
Reservationssystemets datamodeller er byggede ud fra en subklasse af Donkeys \texttt{Model}-klasse ved navn \texttt{FXModel}. Denne tilføjer understøttelse af følgende JavaFX typer og disses subtyper:
...
Reservationssystemets brugergrænseflade er ikke synderligt kompleks, da den i kraft af MVC-arkitekturen blot præsenterer data gennem FXMl Views og via de bagvedliggende JavaFX Controllere delegere brugerinput videre til systemets datamodeller.
